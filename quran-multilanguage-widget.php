...
echo '<a href="https://quran.s3.fr-par.scw.cloud/verset/'.$recitator.'/'.$num[0].'/'.$nbr.'.mp3"><img class="img_play" src="'.plugin_dir_url( __FILE__ ).'/img/play.png"></a>';
}
		}
	}		
	}
...
echo '<br><a href="https://quran.s3.fr-par.scw.cloud/verset/'.$recitator.'/'.$num[0].'/'.$nbr.'.mp3"><img class="img_play" src="'.plugin_dir_url( __FILE__ ).'/img/play.png"></a>';	
}
?>
</span>
<?php	
